...
1\) Типична структура<br>
2\) Шта гледаш у `__manifest__.py`<br>
3\) Добар Python слој<br>
4\) Добар XML слој<br>
5\) Добар security слој<br>
6\) Добар data слој<br>
7\) Добар frontend слој<br>
8\) Добар модул је operationally explainable<br>
9\) Red flags лошег модула<br>
10\) KomITi standard<br>
11\) Како ово примјењујеш на свој capstone<br>
