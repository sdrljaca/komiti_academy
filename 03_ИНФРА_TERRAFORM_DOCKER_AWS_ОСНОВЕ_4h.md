...
## 7) Како се AWS, Docker и Terraform вежу у један flow
...
## 8) Terraform и Compose: исте информације, друго мјесто записа
...
## 10) Како teffraform фајлове претворити у акцију и материјализовати артифакте

### 10.1) Plan није формалност
...
Референца: Ово је објашњено у поглављима `## 7) Како се AWS, Docker и Terraform вежу у један flow` и `## 13) Foundations practical drill`.
...
Референца: Ово је објашњено у поглављима `## 3) Docker и container основе које мораш знати`, `## 7) Како се AWS, Docker и Terraform вежу у један flow` и `## 11) Minimal safe workflow у KomITi-ју`.
...
Референца: Ово је објашњено у поглављима `#### 4.6.2) \`variables.tf\`, \`terraform.tfvars.example\` и \`terraform.tfvars\``, `### 4.4) Структура директоријума: општа и KomITi конкретна`, `### 10.1) Plan није формалност`, `## 11) Minimal safe workflow у KomITi-ју` и `## 14) Local Terraform + Docker Desktop lab за кандидата`.

## 99) Рјешења

1. За дијагностичку биљешку уради ово редом:
	1. У `## 7) Како се AWS, Docker и Terraform вежу у један flow` узми образац како раздвајаш infra слој од application слоја.
