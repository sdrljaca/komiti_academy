...
Испод је мапирање локалног `komiti_academy` lab-а тако да јасно видиш гдје је иста runtime информација записана у Terraform варијанти, а гдје у Compose варијанти. У реалном сценарију Terraform фајлови и Docker Compose се надопуњују, јер сваки користиш за оно што најбоље ради. Али у овом `komiti_academy` lab-у та два приступа треба да посматраш као међусобно искључиве варијанте (користиш или Terraform или Docker Compose, а не оба истовремено за исти runtime).
